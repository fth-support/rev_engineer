...
Begin VB.Form wCNSubDisc2 
   BorderStyle     =   0  'None
   Caption         =   "Discount;klg_Title"
   ClientHeight    =   7755
   ClientLeft      =   3315
   ClientTop       =   2400
   ClientWidth     =   12015
   ControlBox      =   0   'False
   Icon            =   "wCNSubDisc2.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VSFlex7Ctl.VSFlexGrid ogdForm 
      ...
      FormatString    =   $"wCNSubDisc2.frx":058A
      ScrollTrack     =   0   'False
      ScrollBars      =   2
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin VSFlex7Ctl.VSFlexGrid ogdFunc 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   -1  'True
      FormatString    =   $"wCNSubDisc2.frx":0671
      ScrollTrack     =   0   'False
      ScrollBars      =   2
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin XtremeSuiteControls.TabControl otcForm1 
      ...
      Begin VB.Label olaForm 
         Alignment       =   2  'Center
         BackStyle       =   0  'Transparent
         Caption         =   "Discount Type;klg_DiscType"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   17.25
            Charset         =   222
...
'Debug.Print "11"
    ...
    '--------------------------------------------------
    '**********************
    '*Bump 57-08-16 Comsheet204 Missing EJ
    Call SP_CHKInsHDRecovery(tVB_CNTblHD, tVB_CNTerminalNum, tVB_Running, tUT_SaleDate, tVB_Transaction)
    '**********************
    Select Case KeyCode
        Case vbKeyHome
            nVB_OnTopCount = 0
...
'             DoEvents '*KT 53-01-14 DoEvents
        ...
        Select Case Val(Format(tVB_TransactionSub))
            ...
            Case tEN_TrnReturn, tEN_TrnReturnTaxInc, tEN_TrnReturnManualTax  '*Ao 2012/11/26  Return & Return Refer Sale ให้เข้าหน้า Discount เหมือนขาย
                ...
                If bVB_ReEntryMode And Val(Format(tVB_TransactionSub)) = tEN_TrnReturnManualTax Then Exit Sub '*TON 58-0930 TK-ISS3000-601
