...
Begin VB.Form wCNSelMemberType 
   Caption         =   "SELECT FORMAT;klg_Title"
   ClientHeight    =   2490
   ClientLeft      =   5310
   ClientTop       =   2415
   ClientWidth     =   4425
   ControlBox      =   0   'False
   Icon            =   "wCNSelMemberType.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VSFlex7Ctl.VSFlexGrid ogdForm 
      ...
      FormatString    =   $"wCNSelMemberType.frx":058A
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "wCNSelMemberType"
