...
Begin VB.Form wCNSubPay 
   AutoRedraw      =   -1  'True
   BorderStyle     =   0  'None
   Caption         =   "Payment;klg_Title"
   ClientHeight    =   7755
   ClientLeft      =   2835
   ClientTop       =   2235
   ClientWidth     =   12000
   ControlBox      =   0   'False
   Icon            =   "wCNSubPay.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VSFlex7Ctl.VSFlexGrid ogdFunc 
      ...
      FormatString    =   $"wCNSubPay.frx":058A
      ScrollTrack     =   0   'False
      ScrollBars      =   2
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin VSFlex7Ctl.VSFlexGrid ogdTender 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   -1  'True
      FormatString    =   $"wCNSubPay.frx":0667
      ScrollTrack     =   0   'False
      ScrollBars      =   2
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin XtremeSuiteControls.TabControl TabControl1 
      ...
      Begin VB.Label olaTotalDiscName 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "Total Discount;klg_DiscTotal"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   12
            Charset         =   222
   ...
   Begin XtremeSuiteControls.TabControl TabControl1 
      ...
      Begin VB.Label olaDeposit 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "Deposit Amt;klg_DepAmt"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   12
            Charset         =   222
      ...
      Begin VB.Label olaAmtTenderName 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "Amount Tendered;klg_AmtTender"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   12
            Charset         =   222
      ...
      Begin VB.Label olaBalanceName 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "Balance Due;klg_Balance"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   12
            Charset         =   222
...
On Error GoTo ErrHandle
    tSql = "SELECT * FROM " & tVB_CNTblCD & " WITH(NOLOCK) "
...
'                        End If
                        If Trim(UCase(.TextMatrix(.Row, 3))) = "T005" Then  '*Ao 2012/07/27 PRJ10001TK-External Specification Takashimaya Gift Voucher-00.01.00.doc
                            If Not bVB_GVAlwStaffDisc Then '*Thirapong 2021-03-17
                                If W_CHKbCheckTKAllowEmp(nVB_CurTenderSeqNo) Then
                                    ...
                                    Exit Sub
                                End If
                            End If '*If Not bVB_GVAlwStaffDisc Then
                        End If
                        bVB_CNTenderAct = True
...
'                        End Select
                        ...
                        '_____________________________________________________
                         'If tVB_VendorCpnNo = "" Then 'Tao 62-07-05 ของเดิม
                         If cVB_Pay = 0 Then '*Tao 62-07-05 ถ้ากด ยกเลิก ออกมา (อนุญาตให้ไม่ใส่ Vendor Coupon ก็ได้)
                            bVB_CNTenderAct = False
                            otmForm.Enabled = True
                            otmLock.Enabled = True
                            Call SP_DATxRsNothing(orsTemp)
