...
Begin VB.Form wCNTDisc 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Discount Line Item;klg_Title"
   ClientHeight    =   2520
   ClientLeft      =   6420
   ClientTop       =   4995
   ClientWidth     =   4395
   ControlBox      =   0   'False
   Icon            =   "wCNTDisc.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VSFlex7Ctl.VSFlexGrid ogdForm 
      ...
      FormatString    =   $"wCNTDisc.frx":058A
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
...
Private Sub Form_Load()
    ...
    If bVB_LineDiscItems Then
        Me.Caption = "Discount Line Item;klg_Title"
    Else
        Me.Caption = "Discount Line Markdown;klg_Title2"
    End If
    Call SP_FRMxChildCenter(Me)
    Call SP_FRMxGetCaptionFrmDB2Tag(Me)
    Call SP_FRMxSetCapForm(Me)
'    Debug.Print tVB_CNTrnDiscType
End Sub
...
Private Sub ocmOk_Click()
    Select Case ogdForm.Row
        Case 0
            wCNDiscLineItems.olaForm(0).Caption = "% Off"
            wCNDiscLineItems.Caption = "% Off"
            nVB_TypeDiscLineItem = nEN_LnDis1Per
        Case 1
            wCNDiscLineItems.olaForm(0).Caption = "Amount Off"
             wCNDiscLineItems.Caption = "Amount Off"
             nVB_TypeDiscLineItem = nEN_LnDis2Amt
        Case 2
            wCNDiscLineItems.olaForm(0).Caption = "New Price"
            wCNDiscLineItems.Caption = "New Price"
            nVB_TypeDiscLineItem = nEN_LnDis3NewPrice
    End Select
    wCNDiscLineItems.Show vbModal
    Unload Me
End Sub
